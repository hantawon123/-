...
// Servo range
#define _DUTY_MIN 1450    //[3148]  서보의 가동 최소 각도
#define _DUTY_NEU 1550     //[3150] servo neutral position (90 degree)
#define _DUTY_MAX 1690                // [3169] 서보의 최대 가동 각도
...
float ir_distance_filtered() {
  ...
  {
    if(ir_distance() <b)
      dist_list[cnt] = 60 + 195.0 / (b - a) * (ir_distance() - a);
    else
      dist_list[cnt] = 250 + 200.0 / (c - b) * (ir_distance() - b);
    sum += dist_list[cnt];
    cnt++;
  }
